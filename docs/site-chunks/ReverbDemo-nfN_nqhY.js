import{O as e,X as t,Z as n,k as r}from"./site-app-9ZupnJ-U.js";var i=`<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
`,a=e=>e===`loop`?`loop`:`one`;function o(e,t,n,r,i){let o=t=>{let n=e.querySelector(`#${t}`);if(!n)throw Error(`Reverb demo is missing #${t}`);return n},s=o(`phone`),c=o(`blobControl`),l=o(`blobIconPath`),u=o(`blobTime`),d=o(`blobSummary`),f=o(`oneStat`),p=o(`loopStat`),m=o(`toast`),h=o(`dialogLayer`),g=o(`dialogTitle`),_=o(`dialogBody`),v=o(`dropdownMenu`),y=!1,b=`one`,x=768,S=2839,C=1800,w=7200,T=88200,E=performance.now(),D=0,O=!1,k;function A(e){e=Math.max(0,Math.floor(e));let t=Math.floor(e/3600),n=Math.floor(e%3600/60),r=e%60;return t>0?`${t}:${String(n).padStart(2,`0`)}:${String(r).padStart(2,`0`)}`:`${n}:${String(r).padStart(2,`0`)}`}function ee(e){return`${(e*T/1048576).toFixed(1)} MiB`}function te(e){let t=String(e||``).trim().split(`:`);if(t.length<1||t.length>3||t.some(e=>!/^\d+$/.test(e)))return null;let n=t.map(Number);return n.some(e=>!Number.isFinite(e)||e<0)||t.length===3&&(n[1]>=60||n[2]>=60)||t.length===2&&n[1]>=60?null:t.length===3?n[0]*3600+n[1]*60+n[2]:t.length===2?n[0]*60+n[1]:n[0]}function ne(){return b===`one`?x:S}function j(){f.textContent=A(x),p.textContent=A(S),u.textContent=A(ne()),d.textContent=ee(ne())}function M(t){let n=t===`one`?C:w,r=e.querySelector(`[data-buffer-retention="${t}"] [data-retention="time"] input`),i=e.querySelector(`[data-buffer-retention="${t}"] [data-retention="size"] input`),a=e.querySelector(`[data-buffer-retention="${t}"] [data-retention="size"] .supporting`);r&&(r.value=A(n));let o=(n*T/1048576).toFixed(1);i&&(i.value=o),a&&(a.textContent=`Estimated file size: ${o} MiB`)}function N(e,t){t=Math.max(0,Math.floor(t)),e===`one`?(C=t,x=Math.min(x,C)):(w=t,S=Math.min(S,w)),M(e),j()}function re(e){if(e<=0)return;let t=Math.max(0,C-x),n=Math.min(e,t);x+=n;let r=e-n;r>0&&w>0&&(S=Math.min(w,S+r))}function ie(e){r(D),m.textContent=e,m.classList.add(`show`),D=n(()=>m.classList.remove(`show`),1200)}function ae(e,t){g.textContent=e,_.textContent=t,h.classList.add(`show`)}o(`openSettings`).onclick=()=>s.classList.add(`settings-open`),o(`openLibrary`).onclick=()=>s.classList.add(`library-open`),o(`libraryScrim`).onclick=()=>s.classList.remove(`library-open`),o(`dialogClose`).onclick=()=>h.classList.remove(`show`),h.addEventListener(`click`,e=>{e.target===h&&h.classList.remove(`show`)});let oe=o(`aboutScrim`),P=()=>s.classList.remove(`about-open`);o(`brandButton`).onclick=()=>s.classList.add(`about-open`),o(`aboutClose`).onclick=P,oe.onclick=P,e.querySelectorAll(`[data-toast]`).forEach(e=>e.addEventListener(`click`,()=>ie(e.dataset.toast??``))),e.querySelectorAll(`.recording-card`).forEach(e=>e.addEventListener(`click`,()=>ae(e.dataset.recording??`Recording`,`In the Android app this opens RecordingPlayerDialog.`))),e.querySelectorAll(`.buffer-segment`).forEach(t=>t.addEventListener(`click`,()=>{b=a(t.dataset.buffer),e.querySelectorAll(`.buffer-segment`).forEach(e=>e.classList.toggle(`selected`,e===t)),j()})),c.addEventListener(`pointerdown`,()=>c.classList.add(`pressed`)),[`pointerup`,`pointercancel`,`pointerleave`].forEach(e=>c.addEventListener(e,()=>c.classList.remove(`pressed`))),c.onclick=()=>{y=!y,c.classList.toggle(`live`,y),c.setAttribute(`aria-label`,y?`Tap to pause capture`:`Tap to start capture`),l.setAttribute(`d`,y?`M7,5h4v14H7zM13,5h4v14h-4z`:`M3,14c0,-0.55 0.45,-1 1,-1s1,0.45 1,1v2c0,0.55 -0.45,1 -1,1s-1,-0.45 -1,-1zM6.5,11c0,-0.55 0.45,-1 1,-1s1,0.45 1,1v8c0,0.55 -0.45,1 -1,1s-1,-0.45 -1,-1zM10,8c0,-0.55 0.45,-1 1,-1s1,0.45 1,1v14c0,0.55 -0.45,1 -1,1s-1,-0.45 -1,-1zM13.5,5c0,-0.55 0.45,-1 1,-1s1,0.45 1,1v14c0,0.55 -0.45,1 -1,1s-1,-0.45 -1,-1zM17,8c0,-0.55 0.45,-1 1,-1s1,0.45 1,1v8c0,0.55 -0.45,1 -1,1s-1,-0.45 -1,-1zM20.5,11c0,-0.55 0.45,-1 1,-1s1,0.45 1,1v2c0,0.55 -0.45,1 -1,1s-1,-0.45 -1,-1z`),d.classList.toggle(`hidden`,!y),de.setActive(y)};function F(e){if(y&&e-E>=1e3){let t=Math.floor((e-E)/1e3);E+=t*1e3,re(t),j()}else y||(E=e);t(F)}j(),t(F);let I=[...e.querySelectorAll(`.settings-body input,.settings-body .m3-value`)],L=o(`wakeSwitch`),R=`time`;function z(){k={values:I.map(e=>e instanceof HTMLInputElement?e.value:e.textContent??``),oneLimitSeconds:C,loopLimitSeconds:w,wake:L.classList.contains(`on`),retentionMode:R}}z();function B(e=!0){O=e,o(`settingsDone`).classList.toggle(`disabled`,!e),o(`settingsNavClose`).style.display=e?`none`:`block`,o(`settingsNavUndo`).style.display=e?`block`:`none`,o(`settingsNav`).setAttribute(`aria-label`,e?`Undo`:`Close`)}function se(){I.forEach((e,t)=>{let n=k.values[t]??``;e instanceof HTMLInputElement?e.value=n:e.textContent=n}),C=k.oneLimitSeconds,w=k.loopLimitSeconds,x=Math.min(x,C),S=Math.min(S,w),M(`one`),M(`loop`),j(),L.classList.toggle(`on`,k.wake),L.setAttribute(`aria-checked`,String(k.wake)),V(k.retentionMode,!1),B(!1)}o(`settingsNav`).onclick=()=>{O?se():s.classList.remove(`settings-open`)},o(`settingsDone`).onclick=()=>{O&&(z(),B(!1),s.classList.remove(`settings-open`))},e.querySelectorAll(`.settings-body input`).forEach(e=>e.addEventListener(`input`,()=>B(!0))),e.querySelectorAll(`[data-buffer-retention]`).forEach(e=>{let t=a(e.dataset.bufferRetention),n=e.querySelector(`[data-retention="time"] input`),r=e.querySelector(`[data-retention="size"] input`);n&&n.addEventListener(`change`,()=>{let e=te(n.value);e==null?M(t):N(t,e)}),r&&r.addEventListener(`change`,()=>{let e=Number.parseFloat(r.value);Number.isFinite(e)&&e>=0?N(t,e*1024*1024/T):M(t)})}),L.onclick=()=>{let e=!L.classList.contains(`on`);L.classList.toggle(`on`,e),L.setAttribute(`aria-checked`,String(e)),B(!0)};function V(t,n=!0){R=t,e.querySelectorAll(`[data-retention]`).forEach(e=>{let n=e.dataset.retention===t;e.classList.toggle(`inactive`,!n);let r=e.querySelector(`.m3-prefix`);r&&(r.textContent=n?``:`=`)}),n&&B(!0)}e.querySelectorAll(`[data-retention="time"] input`).forEach(e=>e.addEventListener(`focus`,()=>V(`time`))),e.querySelectorAll(`[data-retention="size"] input`).forEach(e=>e.addEventListener(`focus`,()=>V(`size`)));let H=null;function U(){v.classList.remove(`show`),v.innerHTML=``,H=null}e.addEventListener(`pointerdown`,e=>{H&&e.target instanceof Node&&!v.contains(e.target)&&!H.contains(e.target)&&U()},!0),e.querySelectorAll(`.m3-fieldset.dropdown`).forEach(t=>t.addEventListener(`click`,n=>{n.stopPropagation(),U(),H=t;let r=t.getBoundingClientRect(),i=s.getBoundingClientRect(),a=(t.dataset.options||``).split(`|`);v.innerHTML=``,a.forEach(n=>{let r=e.createElement(`button`);r.className=`dropdown-item`,r.textContent=n,r.onclick=()=>{t.querySelector(`.m3-value`).textContent=n,B(!0),U()},v.appendChild(r)}),v.style.left=`${Math.min(r.left,i.right-Math.max(180,r.width))}px`,v.style.top=`${Math.min(r.bottom+2,window.innerHeight-12-a.length*48)}px`,v.style.width=`${Math.max(180,r.width)}px`,v.classList.add(`show`)}));function W(e,t){if(s.classList.contains(`settings-open`)||s.classList.contains(`library-open`)||t instanceof Element&&t.closest(`button,input,a,[role="button"],[role="switch"],.m3-fieldset`))return null;let n=c.getBoundingClientRect();return e<n.top?`settings`:e>n.bottom?`library`:null}function G(e,t){return e===`settings`&&t>=52?(s.classList.add(`settings-open`),!0):e===`library`&&t<=-52&&(s.classList.add(`library-open`),!0)}let K=null,q=null,J=e=>{K!==null&&q&&G(q,e.clientY-K)&&Y()},Y=()=>{K=null,q=null,s.removeEventListener(`pointermove`,J)};s.addEventListener(`pointerdown`,e=>{e.pointerType!==`touch`&&(q=W(e.clientY,e.target),K=q?e.clientY:null,q&&s.addEventListener(`pointermove`,J,{passive:!0}))}),s.addEventListener(`pointerup`,Y),s.addEventListener(`pointercancel`,Y);let X=null,Z=null;s.addEventListener(`touchstart`,e=>{if(e.touches.length!==1)return;let t=e.touches[0];Z=W(t.clientY,e.target),X=Z?t.clientY:null,Z&&e.preventDefault()},{passive:!1}),s.addEventListener(`touchmove`,e=>{if(X===null||!Z||e.touches.length!==1)return;e.preventDefault();let t=e.touches[0];G(Z,t.clientY-X)&&(X=null,Z=null)},{passive:!1});let Q=()=>{X=null,Z=null};s.addEventListener(`touchend`,Q),s.addEventListener(`touchcancel`,Q);function $(t,n,r){let i=e.createElement(`span`);i.style.cssText=`position:absolute;pointer-events:none;visibility:hidden;color:var(${n},${r})`,(t.parentNode??s).appendChild(i);let a=getComputedStyle(i).color||r;return i.remove(),a}function ce(n){let r=n.getContext(`webgl`,{alpha:!0,premultipliedAlpha:!0,antialias:!0});if(!r)return ue(n);let a=r,o=a.getShaderPrecisionFormat(a.FRAGMENT_SHADER,a.HIGH_FLOAT),s=`precision ${o&&o.precision?`highp`:`mediump`} float;
