...
(() => {
  ...
  const read = () => {
    ...
    if (selected === "system") {
      ...
      return { color, selected: "system", font, ...colors[color], custom: { ...colors[color] } };
    }
    if (selected === "custom") {
      ...
      return { color: "custom", selected: "custom", font, ...theme, custom: { ...theme } };
    }
    if (selected.startsWith("saved:")) {
      ...
      return { color: selected, selected, font, ...theme, custom: { ...theme }, savedName: saved?.name || "Saved theme" };
    }
    const theme = colors[selected] || colors.light;
    return { color: selected, selected, font, ...theme, custom: { ...theme } };
  };
