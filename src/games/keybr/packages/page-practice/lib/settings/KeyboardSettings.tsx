...
function GeometryProp(): ReactNode {
    ...
    return (<>
      ...
      <Explainer>
        <Description>
          <FormattedMessage id="settings.keyboardColors.description" defaultMessage="Show color coding of the keyboard zones. Use this option to learn which finger to use to press a key."/>
        </Description>
      </Explainer>
      <FieldList>
        <Field>
      ...
      <Explainer>
        <Description>
          <FormattedMessage id="settings.keyboardPointers.description" defaultMessage="Highlight a key that must to be pressed next. Use this option to quickly find the position of a key if you don’t know the keyboard layout well."/>
        </Description>
      </Explainer>
    </>);
}
