...
export function KeyExtendedDetails({ lessonKey, keyStats, }: {
    ...
    return (<div class={styles.root}>
      ...
      <LearningRateDescription lessonKey={lessonKey} learningRate={learningRate}/>
      <KeyDetailsChart lessonKey={lessonKey} learningRate={learningRate} width="50rem" height="15rem"/>
    </div>);
}
