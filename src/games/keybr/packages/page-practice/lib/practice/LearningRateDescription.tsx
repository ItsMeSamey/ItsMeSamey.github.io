...
export function LearningRateDescription({ lessonKey, learningRate, }: {
    ...
    if (learningRate != null &&
        ...
        <Name>
          <FormattedMessage id="learningRate.remainingLessons" defaultMessage={"Approximately {remainingLessons} lessons remaining to " +
                ...
                remainingLessons: (<Value value={formatNumber(learningRate.remainingLessons)}/>),
                certainty: (<Value value={formatPercents(learningRate.certainty)}/>),
            }}/>
        </Name>
      </Para>);
    }
