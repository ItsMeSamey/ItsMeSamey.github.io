...
export function KeyFrequencyHistogram({ keyStatsMap, width, height, }: {
...
function boxes(box: Rect) {
    ...
    const boxMiss = new Rect(box.x, boxHit.y + boxHit.height + 10, box.width, box.height * 0.33 - 10);
    const boxRatio = new Rect(box.x, boxMiss.y + boxMiss.height + 10, box.width, box.height * 0.33 - 10);
