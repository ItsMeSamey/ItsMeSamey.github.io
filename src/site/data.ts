...
export const projects:Entry[]=[
  ...
  {title:'CNN',href:'/projects/cnn/',kind:'Project',note:'CNN in Zig. Draw something and run the model in-browser with WASM.',tags:['zig','ml','mnist'],demo:true},
];
